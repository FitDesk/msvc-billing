...
public class PaymentMethodServiceImpl implements PaymentMethodService {
    ...
    private void sendPaymentApprovedEvent(
        ...
        try {
            ...
            kafkaTemplate.send("payment-approved-event-topic", event).whenComplete((stringObjectSendResult, throwable) ->
                    log.info(
                            "Evento de pago aprobado (tarjeta guardada) enviado: {}", event)
            );
            log.info(
